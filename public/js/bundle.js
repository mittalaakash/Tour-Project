...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWthLWFzaG1pdCIsImEiOiJja3FsY3huM3MzempjMndtdjFhaG96MmllIn0.2dfhP9-mp9jwWtEJNzrroA';
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.reload(true); // true because it will reload from server and not from browser cache
...
},{"axios":"../../node_modules/axios/index.js","../../Utils/catchAsync":"../../Utils/catchAsync.js","./alerts":"alerts.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51JDnaySI0UnuWRRUOw6xhClPW7oQ3VQo24tu85ZzmtTJV1DwUZztCUMjp0BtX6EvZ3ApkGMBYpZpDzyxioBIqdBV002yeFBAqU');
